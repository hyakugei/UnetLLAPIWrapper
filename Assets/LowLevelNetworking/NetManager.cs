...
namespace LowLevelNetworking
{
	...
	public static class NetManager
	{
		...
		static public ConnectionConfig mConnectionConfig = new ConnectionConfig();
		static public GlobalConfig mGlobalConfig = new GlobalConfig();
		...
		public static void PollEvents()
		{
			...
			while(mIsInitialized && networkEvent != NetworkEventType.Nothing)
			{
				...
				if(i != -1)
				{
					if(mServers[i].OnMessage != null) mServers[i].OnMessage(networkEvent, connectionId, channelId, buffer, dataSize);
				}
				...
				if(i != -1)
				{
					if(mClients[i].OnMessage != null) mClients[i].OnMessage(networkEvent, connectionId, channelId, buffer, dataSize);
				}
				...
				// Server Connect Event
					...
					if(i != -1)
					{
						...
						if(mServers[i].OnConnection != null) mServers[i].OnConnection(connectionId, channelId, buffer, dataSize);
					}
				...
				// Client Connect Event
					...
					if(i != -1)
					{
						...
						if(mClients[i].OnConnection != null) mClients[i].OnConnection(connectionId, channelId, buffer, dataSize);
					}
				...
				// Server received data
					...
					if(i != -1)
					{
						if(mServers[i].OnData != null) mServers[i].OnData(connectionId, channelId, buffer, dataSize);
				...
				// Client Received Data
					...
					if(i != -1)
					{
						if(mClients[i].OnData != null) mClients[i].OnData(connectionId, channelId, buffer, dataSize);
					}
					break;
				...
				// Server Disconnect Event
					...
					if(i != -1)
					{
						...
						if(mServers[i].OnDisconnection != null) mServers[i].OnDisconnection(connectionId, channelId, buffer, dataSize);
					}
				...
				// Client Disconnect Event
					...
					if(i != -1)
					{
						...
						if(mClients[i].OnDisconnection != null) mClients[i].OnDisconnection(connectionId, channelId, buffer, dataSize);
					}
